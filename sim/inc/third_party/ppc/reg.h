...
#ifndef _POWERPC_REG_H
#define _POWERPC_REG_H

/* Pickup Book E specific registers. */
#if defined(CONFIG_BOOKE) || defined(CONFIG_40x)
#include <third_party/ppc/reg_booke.h>
#endif /* CONFIG_BOOKE || CONFIG_40x */

#ifdef CONFIG_FSL_EMB_PERFMON
#include <third_party/ppc/reg_fsl_emb.h>
#endif

#ifdef CONFIG_8xx
#include <third_party/ppc/reg_8xx.h>
#endif /* CONFIG_8xx */

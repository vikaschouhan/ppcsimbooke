 ...
 * 1. ppc_tlb ( int n_tlbs, t_tlb_parms *tlbparms ) .
 *    @brief :- 
...
class ppc_tlb {
    ...
    ppc_tlb(size_t n_tlbs, struct t_tlb_params *tlbparms){
        init_ppc_tlb(n_tlbs);
 ...
 * l2 tlb for e500v2
 * Eg:-
 * ppc_tlb  tlb_l2(2, 256, 2, 0, 0, "tlb0", 16, 0, 0, 1, "tlb1" );
 */
